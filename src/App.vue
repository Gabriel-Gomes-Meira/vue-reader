<template>
    ...
    <div class="navbar bg-base-100 mb-2">
        <div class="flex-none">
            ...
            data-drawer-target="default-flowbite-drawer" data-drawer-show="default-flowbite-drawer" aria-controls="default-flowbite-drawer">
        ...
        <div class="flex-1">
            <a class="btn btn-ghost normal-case text-xl">Vue Reader</a>
        </div>
        <div class="flex-none w-32">
            <label for="bookmark-drawer" class="btn btn-square btn-ghost w-full gap-1">
                BookMarks
            ...
            <!-- <button class="btn btn-square btn-ghost w-full gap-1"></button> -->
        </div>
    </div>
    ...
    <div id="default-flowbite-drawer" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
   ...
   <button type="button" data-drawer-hide="default-flowbite-drawer" aria-controls="default-flowbite-drawer" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
